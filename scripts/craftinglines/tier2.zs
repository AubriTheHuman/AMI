...
mixing.addRecipe("simple_spirit_solution_mixing", "heated", <fluid:amicore:simple_spirit_solution> * 1000, [<tag:items:malum:spirits/basic_spirits>], [<fluid:minecraft:water> * 1000], 600);
